 ...
 <section id="middle">
        ...
        <header id="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">ID: <?= Html::encode($this->title) ?></li>
            </ol>
        </header>
        <!-- /page title -->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="callout ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12"><!-- left text -->
                                    <?= Html::a('<i class="fa fa-edit"></i> <span>Edit</span>', ['update', 'id' => $model->id], ['class' => 'btn btn-3d btn-lg btn-reveal btn-dirtygreen']) ?>
                                    <?= Html::a('<i class="fa fa-trash"></i> <span>Delete</span>', ['delete', 'id' => $model->id], [
                                        'class' => 'btn btn-3d btn-lg btn-reveal btn-danger',
                                        'data' => [
                        ...
                        <div class="col-md-9">
                            ...
                            <h2><strong>ID: <?= Html::encode($this->title) ?></strong> </h2>
                            <?= DetailView::widget([
                                'model' => $model,
                                'attributes' => [
                                    'id',
